<%@ Page Title="" Language="C#" MasterPageFile="~/start.Master" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="Cyberlink.register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <asp:HyperLink ID="HyperLink1" runat="server" ImageUrl="~/image/home.png" NavigateUrl="~/Default.aspx" Target="_self" CssClass="link">HyperLink</asp:HyperLink>
        <div class="div">
            <asp:TextBox ID="TextBox5" onkeypress="return lettersOnly(event)" MaxLength="20" runat="server" placeholder="Nome" CssClass="textbox"></asp:TextBox>
            ...
            <asp:TextBox ID="TextBox8" type="password" MaxLength="50" runat="server" placeholder="Digite a Senha" CssClass="textbox"></asp:TextBox>
            <asp:TextBox ID="TextBox9" type="password" MaxLength="50" runat="server" placeholder="Repita a Senha" CssClass="textbox"></asp:TextBox>
            ...
            <asp:Button ID="Button2" runat="server" CssClass="button" Text="Cadastrar" OnClick="Button2_Click" />
        </div>
